...
AiEsp32RotaryEncoder::AiEsp32RotaryEncoder(uint8_t encoder_APin, uint8_t encoder_BPin, uint8_t encoder_ButtonPin, int8_t encoder_VccPin, uint8_t encoderSteps)
{
	this->old_AB = 0;
